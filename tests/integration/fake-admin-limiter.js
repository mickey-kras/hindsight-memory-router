...
const server = http.createServer((req, res) => {
  ...
  // Edge limiting is intentionally pre-auth. It protects router capacity from
  // unauthenticated bursts, so excess invalid requests may receive 429 before 401.
  ...
  const upstream = http.request(
    {
      ...
      method,
      path,
      // Forward only application headers; hop-by-hop and framing headers are
      // generated by Node for the new upstream request.
      headers: {
